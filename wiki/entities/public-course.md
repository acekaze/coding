...
An open-course initiative in `C:/코딩/공개과정` that turns a teaching worldview into a participant-facing paid product.

## Why it matters in this wiki

It is one of the clearest portfolio expressions where offer design, learning philosophy, operations, landing-page assets, and participant outputs are being developed together.

## Key facts

- the intended audience is existing instructors, facilitators, HRD practitioners, and subject-matter professionals who already teach
...
- worldview anchor: [jeon-jongmok](./jeon-jongmok.md)

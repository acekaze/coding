...
# AI education proposal portfolio
...
It is the clearest current interface between educational worldview and commercial enterprise language.
It also provides evidence that AI education is being designed around organizational role leverage, not just generic tool adoption.

## Key facts

- the integrated proposal argues that managers and practitioners should be trained separately
- manager proposals emphasize instruction design, approval quality, decision logic, and 30-day operating routines
...
- linked workbench: [instructional-design-workbench](./instructional-design-workbench.md)

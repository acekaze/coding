...
related:
  ...
  - wiki/entities/public-course.md
  - wiki/entities/youth-speech-prescription.md
  - wiki/entities/ai-education-proposal-portfolio.md
  - wiki/entities/instructional-design-workbench.md
---

# Current workstream map 2026-04

## Question

How do the currently active workstreams fit together as one coherent map?
...
The current portfolio does not read like a set of unrelated side projects.
It reads like a system that repeatedly does the same high-level move in different markets:

- diagnose the real human or organizational problem
- interpret that problem into usable language
...
- [jeon-jongmok](../entities/jeon-jongmok.md)
- [public-course](../entities/public-course.md)
- [youth-speech-prescription](../entities/youth-speech-prescription.md)
- [ai-education-proposal-portfolio](../entities/ai-education-proposal-portfolio.md)
- [instructional-design-workbench](../entities/instructional-design-workbench.md)
